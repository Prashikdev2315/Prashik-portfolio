...
import { Github, Brain, Pill, Sprout, ExternalLink } from "lucide-react"
...
const projects = [
  {
    ...
    description:
      "Built a Flutter mobile app to help Indian farmers monitor soil health in real time using ESP32 IoT sensors and AI-driven fertiliser recommendations.",
    highlights: [
      "Integrated live ESP32 sensor data (N, P, K, pH, EC, ORP) via Firebase RTDB",
      "Built a two-phase analysis system — soil prep (Phase 1) and flooded-field ORP (Phase 2)",
      "Generated AI fertiliser dosage recommendations (Urea, DAP, MOP) using Llama 3.1 / Groq",
      "Built multilingual UI for 9 Indian languages with real-time switching",
    ],
    tags: ["Flutter", "Firebase RTDB", "ESP32 / IoT", "LLM (Llama 3.1)", "Provider", "Python REST API"],
...
function ProjectCard({ project }: { project: typeof projects[0] }) {
  return (
    <div
      className="group bg-card border border-border rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 flex flex-col h-full"
    >
      {/* Project Header */}
